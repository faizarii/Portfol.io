...
export const FooterInfo: React.FC = () => {
  ...
  return (
    <footer className="relative z-20 w-full pb-8 sm:pb-10 md:pb-12 px-6 sm:px-10 md:px-16 lg:px-20 text-[13.5px] sm:text-[14.5px] md:text-[15px] leading-relaxed text-[#A1A7B4]">
