...
export const portfolioConfig: PortfolioConfig = {
    ...
    items: [
      ...
      },
      {
        ...
        highlights: [
          ...
          'Built the backend AI engine using Python and FastAPI, deploying a model with >80% accuracy for demand forecasting.',
      ...
      },
      {
        ...
        location: 'Jakarta, Indonesia',
        description: 'Explored the fundamentals of building and scaling new ventures, covering essential business concepts, startup methodologies, and the process of transforming ideas into viable products.',
        highlights: [
          'Learned core principles of entrepreneurship, lean startup methodology, and business model development.',
          'Explored startup ecosystem dynamics, pitching, and strategies for launching early-stage ventures.',
          'Developed an understanding of how to identify market opportunities and validate product-market fit.',
        ],
        skills: ['Data Structures', 'Algorithms', 'C/C++', 'Python', 'OOP', 'Git & GitHub'],
        images: [
          { src: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&auto=format&fit=crop&q=80', alt: 'Early coding sessions' },
        ],
      },
    ],
  },
  ...
  projects: {
    ...
    items: [
      ...
      {
        title: 'Portofol.io',
        description: 'My personal website to showcase my projects and my information.',
        year: '2026',
        ...
        highlights: [
          'Real-time raymarched reflections and custom environment HDRI lighting studio.',
          'Parametric mesh boolean operations (union, difference, intersection) in WebGL.',
          'Optimized glTF/GLB binary export pipeline with Draco geometry compression.',
        ],
        gallery: [
